...
import { initDefaultProps, getOptionProps, getSlots } from '@util/vc-util/props-util'
...
export default {
    ...
    props: initDefaultProps({
        ...
        icon: PropTypes.oneOfType([PropTypes.object, PropTypes.func]), // icon
        focusable: PropTypes.bool, // 聚焦
        selectable: PropTypes.bool, // 选择
        disabled: PropTypes.bool,
        multiple: PropTypes.bool,
        checkable: PropTypes.oneOfType([PropTypes.object, PropTypes.bool]),
        checkStrictly: PropTypes.bool,
        draggable: PropTypes.bool, // 拖拽
        defaultExpandParent: PropTypes.bool,
        autoExpandParent: PropTypes.bool,
        defaultExpandAll: PropTypes.bool, // 展开全部
